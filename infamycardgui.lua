...
function InfamyCardGui:show_rank(rank)
	...
	local rank_icon, icon_texture_rect = tweak_data.infamy:rank_icon_data(rank)
	local icon_color = (Color.white - (tweak_data.infamy:rank_icon_color(rank) or Color(0, 0, 0))):with_alpha(1)
	...
	local rank_string = managers.experience:rank_string(rank) or ""
